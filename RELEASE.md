...
| D. Artifact Staging | Produce the exact publishable files | Nothing in repo; artifacts outside it | Per-target native builds, extraction/run tests, checksums, manifest | All artifacts verified | Missing/incorrect artifact → NOT READY |
