...
description: Recipe examples built from functionality supported by Sinter v0.5.1.
---

All examples below use only resource types and fields implemented in v0.5.1.
