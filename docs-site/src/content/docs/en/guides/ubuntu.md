...
26.04 LTS amd64 is supported with the same `apt` backend. The repository support policy covers both version lines; the new 26.04
qualification belongs to Unreleased, not the published v0.2.1 support claim.
