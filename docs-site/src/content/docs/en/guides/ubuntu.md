...
26.04 LTS amd64 is supported with the same `apt` backend. The repository support policy covers both version lines; 26.04 qualification is included in the released v0.3.0.
